...
class Sunat
{
    ...
    public $_legal = false;
    public $_trabs = false;
    public function __construct($representantes_legales = false, $cantidad_trabajadores = false)
    {
    ...
    public function numTrabajadores($ruc)
    {
        $url = "http://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/jcrS00Alias";
        $data = array(
            "accion" => "getCantTrab",
    ...
    public function RepresentanteLegal($ruc)
    {
        $url = "http://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/jcrS00Alias";
        $data = array(
            "accion" => "getRepLeg",
